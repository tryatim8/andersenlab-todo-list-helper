...
def test_tasks_list_failed(
    api_client: APIClient,
    tasks_serialized: List[ReturnDict[str, Any]],
    user: UserType,
) -> None:
...
@pytest.mark.django_db
def test_task_detail_by_pk_successful(
    auth_client: APIClient, tasks_list: List[Task],
) -> None:
...
def test_task_detail_by_pk_failed(
    auth_client: APIClient, tasks_list: List[Task], task_pk: int,
) -> None:
    response = auth_client.get(f'/api/tasks/{task_pk}/')
...
def test_task_create_successful(
    auth_client: APIClient, user: UserType,
) -> None:
...
@pytest.mark.django_db
def test_task_full_change_by_id_successful(
    auth_client: APIClient, tasks_serialized: List[ReturnDict[str, Any]],
) -> None:
...
@pytest.mark.django_db
def test_task_delete_by_id_successful(
    auth_client: APIClient, tasks_serialized: List[ReturnDict[str, Any]],
) -> None:
...
def test_task_delete_by_id_failed(
    auth_client: APIClient,
    tasks_serialized: List[ReturnDict[str, Any]],
    task_pk: int,
) -> None:
...
@pytest.mark.django_db
def test_task_mark_completed_by_id_successful(
    auth_client: APIClient, tasks_serialized: List[ReturnDict[str, Any]],
) -> None:
...
@pytest.mark.django_db
def test_all_tasks_list_from_user_client_failed(
    auth_client: APIClient,
    tasks_serialized: List[ReturnDict[str, Any]]
) -> None:
